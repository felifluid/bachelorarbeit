...
With it, its possible to easily identify how plasma and geometry parameters affect plasma structures.
...
This thesis is organized as follows: First, all necessary background information is supplied in Chapter @chap:background[].
This includes insight into the working details of GKW and ToPoVis as well as some technical concepts of interpolation and triangulation.
